...
pinconfigType pinconfig[6] = {
    ...
    { .gpio = { .pin = HS_P2, .port = PORT_HS_P2 }, .dns_pins = { .pin = DEN_1_2, .port = PORT_DEN_1_2 }, .dsel_pins = { .pin = DSEL_1_2, .port = PORT_DSEL_1_2 }, .den = 1, .dsel = 1, .adc_channel = 1, .default_state = false },
    { .gpio = { .pin = HS_P3, .port = PORT_HS_P3 }, .dns_pins = { .pin = DEN_3_4, .port = PORT_DEN_3_4 }, .dsel_pins = { .pin = DSEL_1_2, .port = PORT_DSEL_3_4 }, .den = 1, .dsel = 0, .adc_channel = 0, .default_state = false },
