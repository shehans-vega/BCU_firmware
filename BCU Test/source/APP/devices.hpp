...
void create_devices() {
    ...
    devices[0] = new latch_Device(&channels[4], &highbeamButton, 1);
    devices[1] = new latch_Device(&channels[2], &lowbeamButton, 1);
    ...
    devices[5] = new momentary_Device(&channels[5], &hornButton, 1);
}
