...
void create_devices() {
    ...
    devices[0] = new momentary_Device(&channels[2], &hornButton, 1 , 3, 2000);
    devices[1] = new momentary_Device(&channels[5], &lowbeamButton, 1,3,2000);
    devices[2] = new momentary_Device(&channels[1], &passButton, 1,4,2000);
    devices[3] = new toggle_Device(&channels[0], &leftButton, 1,3,2000);
    devices[4] = new toggle_Device(&channels[4], &rightButton, 1,3,2000);
    devices[5] = new momentary_Device(&channels[3], &highbeamButton, 1,3,2000);
}       
