...
# Generate eRPC code if eRPC component is present
# otherwise just use an empty rule.
generate_erpc_code::
...
#
# If eRPC component is present, add eRPC tools and rules
#
-include ./components/spc5_freertos_erpc_component/mak/rules.mk
